...
OUT  = "/Users/vladandrieiev/Desktop/Кухня/output/rozkladka_13-19_04_2026.html"
...
lines = [
    ...
    '<meta charset="UTF-8">',
    '<title>Розкладка — Усього за період 13.04–19.04.2026</title>',
    f'<style>{CSS}</style>',
    '</head><body>',
    ...
    '    <div>на час з 13.04 по 19.04.2026</div>',
    '  </div>',
    ...
    '  </div>',
    '</div>',
    '<h2>Усього за період — 13.04–19.04.2026 — Підрозділ Т0920</h2>',
    '<table>',
]
